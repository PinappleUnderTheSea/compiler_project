...
bb2:
  %r106 = getelementptr [10 x %Node], ptr %r105, i32 0, i32 2
  %r107 = getelementptr [10 x %Node], ptr %r106, i32 0, i32 0
  %r108 = call i32 @getint()
  store i32 %r108, ptr %r107, align 4
  %r109 = getelementptr [10 x %Node], ptr %r105, i32 0, i32 2
  %r110 = getelementptr [10 x %Node], ptr %r109, i32 0, i32 1
...
bb3:
  ...
  %r126 = getelementptr [10 x %Node], ptr %r125, i32 0, i32 0
  %r127 = load i32, ptr %r126, align 4
  %r128 = getelementptr [10 x %Node], ptr @e, i32 0, i32 2
  %r129 = getelementptr [10 x %Node], ptr %r128, i32 0, i32 1
